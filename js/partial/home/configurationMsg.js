    ...
    getConfMsg: function () {
        ...
        require(['plugins/jtopo-0.4.8-min'], function () {
            ...
            function drawCofMsg(data){
                ...
                var zcNode = addNode('电池', 'Battery', 50, 160, 74, 53);
                var nbqNode = addNode('PCS', 'pcs', 300, 160, 64, 64);
                var dbNode = addNode('变压器', 'transformer', 650, 55, 75, 60);
                var dwNode = addNode('电网', 'powerGrid', 900, 55, 75, 80);
                var ydfhNode = addNode('负载', 'load', 850, 250, 83, 100);
                ...
                var pdLineF = '';
                var pdLineE = '';
                if(data.bus_activepower.substring(0,1) === '-'){
                    bpLineF = nbqNode;
                    bpLineE = zcNode;
                    pdLineF = dotNode;
                    pdLineE = nbqNode;
